...
namespace PT.PM.Cli.Tests
{
    ...
    public class CliTests
    {
        ...
        public void CheckCli_Patterns_CorrectErrorMessages()
        {
            ...
            var result = ProcessUtils.SetupHiddenProcessAndStart(TestUtility.PtPmExePath, $"--stage {Stage.Pattern} --patterns {patternsStr} --log-errors");
        ...
        public void CheckCli_LogPath_FilesInProperDirectory()
        {
            ...
            try
            {
                ...
                var result = ProcessUtils.SetupHiddenProcessAndStart(TestUtility.PtPmExePath, $"--stage {Stage.Pattern} --patterns {patternsStr} --logs-dir \"{logPath}\"");
